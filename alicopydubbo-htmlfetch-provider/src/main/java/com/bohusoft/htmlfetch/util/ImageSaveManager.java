...
public class ImageSaveManager {
	...
	private static final ExecutorService saveImageThreadPool = Executors.newFixedThreadPool(3);
	...
	public static Future<Map<String,Object>> saveToAli(String albumId,String name,byte[] data,Map<String,Object> map,AlbumService albumService){
		SaveImageToAliTask aliTask=new SaveImageToAliTask(albumId, name, data, map, albumService);
		 Future<Map<String,Object>> fu=saveImageThreadPool.submit(aliTask);
		 return fu;
	}
