...
public class HttpOpenClient {
	...
	public static LinkedHashMap<String,Object>  post(String url,Map<String,Object> params) throws UnsupportedEncodingException{
	...
	public static void main(String[] args) throws HttpException, IOException {
		//HttpOpenClient.getHttpClient();
		//HttpOpenClient.getSkuInfo("{}");
	}
}	
