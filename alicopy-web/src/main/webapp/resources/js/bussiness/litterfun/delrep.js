function taobaoList(){
		...
		var ItemView = Backbone.View.extend({
			...
			remove:function(){
				...
				$.ajax({
					...
					data:{"offerId":this.model.get("offerId")},
					url:URL_ROOT+"/litterfun/delRepProduct",
					dataType:"json",
		...
		var ItemListView = Backbone.View.extend({
		    ...
		    loadItems:function(callback){
		    	...
		    	var _this=this;
		    	this.itemList.fetch({silent: true,data:{}, success:function(collection, response){ //注释四
