function taobaoList(){
		...
		var ItemListView = Backbone.View.extend({
		    ...
		    loadItems:function(callback){
		    	...
		    	var _this=this;
		    	this.itemList.fetch({silent: true,data:{"pageNo":_this.current_page,"url":_this.searchVoBean.url,"shopType":_this.searchVoBean.shopType,"cate":_this.searchVoBean.cate,"cateUrl":_this.searchVoBean.cateUrl}, success:function(collection, response){ //注释四
