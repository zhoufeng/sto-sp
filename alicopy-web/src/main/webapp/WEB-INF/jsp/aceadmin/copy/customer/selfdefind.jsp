...
<div class="col-sm-12">
			<div class="widget-box transparent">
				...
				<div class="widget-body"><div class="widget-body-inner" style="display: block;">
					<div class="widget-main">
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
						    ...
						    <div class="col-xs-4">
						    <label>
							<input name="otherHref"  type="checkbox" class="ace" >
					...
					<div class="form-group has-info">
						<label for="inputInfo"
							class="col-sm-3 control-label no-padding-right">主图地址:用逗号隔开</label>

						<div class="col-sm-9" >
							<span class="block input-icon input-icon-right"> <textarea
								 name="imageList" class="autosize-transition form-control" >https://cbu01.alicdn.com/img/ibank/2016/595/686/2838686595_1006528253.jpg,https://cbu01.alicdn.com/img/ibank/2016/933/901/2840109339_1006528253.jpg</textarea><i
					...
					<div class="form-group has-info">
						<label for="inputInfo"
							class="col-sm-3 control-label no-padding-right">详情源码:</label>

						<div class="col-sm-9" >
							<span class="block input-icon input-icon-right"> <textarea
								 name="selfDesc" class="autosize-transition form-control" > </textarea><i
								class="icon-info-sign"></i> </span>
						</div>
	...
	<script src="${URL_ROOT}/resources/ace/assets/js/chosen.jquery.min.js"></script>		
	<script src="${URL_ROOT}/resources/js/bussiness/customer/selfdefind.js?d=2.0"></script>