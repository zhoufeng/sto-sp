			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-right" role="navigation">
					<ul class="nav ace-nav">
						<li>
						<a target="_blank" href="http://pc.1688.com/product/operate.htm?key=k_bbyjfz" >你还剩余${sessionScope.aliInfo.leftDay }天的使用时间,点击续订</a>  
						</li>	
					
						<li>
						<a target="_blank" href="http://amos.alicdn.com/msg.aw?spm=a261gw.7796156.0.0.yqDEF3&v=2&uid=kongjishisecom&site=cnalichn&s=4" ><img border="0" src="http://amos.alicdn.com/online.aw?v=2&uid=kongjishisecom&site=cnalichn&s=4&charset=UTF-8" alt="有事联系我" /></a>
						</li>
						<li>
							<a  href="#"  style="cursor: pointer;" id="maxWinHandle">
						<span class="label label-xlg label-primary arrowed arrowed-right">最大化窗口</span>
						</a>
						<li>
