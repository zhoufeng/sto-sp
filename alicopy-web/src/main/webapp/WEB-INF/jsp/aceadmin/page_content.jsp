		...
		<div class="col-xs-12">
			...
			<div class="alert alert-block alert-success">
				...
				<i class="icon-ok green"></i> 欢迎使用 <strong class="green">
					Ace后台管理系统 <small>(v1.2)</small> </strong> ,轻量级好用的后台管理系统模版.
			</div>
							...
							<div class="widget-toolbar no-border">
								...
								<ul
									...
									<li class="active"><a href="#" class="blue"> <i
											class="icon-caret-right bigger-110">&nbsp;</i> 本周 </a></li>

									<li><a href="#"> <i
											class="icon-caret-right bigger-110 invisible">&nbsp;</i> 上周 </a>
									</li>

									<li><a href="#"> <i
											class="icon-caret-right bigger-110 invisible">&nbsp;</i> 本月 </a>
									</li>

									<li><a href="#"> <i
											class="icon-caret-right bigger-110 invisible">&nbsp;</i> 上月 </a>
									</li>
								</ul>
							</div>
						</div>
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><small> <s class="red"></s> </small> <b
												class="green">$16.45</b></td>
										...
										<tr>
											...
											<td><small> <s class="red">$24.99</s> </small> <b
												class="green">$19.95</b></td>
										...
										<ul id="tasks" class="item-list">
											...
											<li class="item-red clearfix"><label class="inline">
												...
												<div class="pull-right action-buttons">
													<a href="#" class="blue"> <i
														class="icon-pencil bigger-130"></i> </a> <span class="vbar"></span>

													<a href="#" class="red"> <i
														class="icon-trash bigger-130"></i> </a> <span class="vbar"></span>
									...
									<div id="member-tab" class="tab-pane">
										<div class="clearfix">
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Bob Doe's avatar" src="${URL_ROOT}/resources/ace/assets/avatars/user.jpg" />
												</div>
															...
															<ul
																...
																<li><a href="#" class="tooltip-warning"
																	data-rel="tooltip" title="Reject"> <span
																		class="orange"> <i
																			class="icon-remove bigger-110"></i> </span> </a></li>
											...
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Joe Doe's avatar"
														src="${URL_ROOT}/resources/ace/assets/avatars/avatar2.png" />
												</div>
											...
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Jim Doe's avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar.png" />
												</div>
											...
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Alex Doe's avatar"
														src="${URL_ROOT}/resources/ace/assets/avatars/avatar5.png" />
												</div>
											...
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Susan's avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar3.png" />
												</div>
											...
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Phil Doe's avatar"
														src="${URL_ROOT}/resources/ace/assets/avatars/avatar4.png" />
												</div>
											...
											<div class="itemdiv memberdiv">
												<div class="user">
													<img alt="Alexa Doe's avatar"
														src="${URL_ROOT}/resources/ace/assets/avatars/avatar1.png" />
												</div>
										...
										<div class="center">
											<i class="icon-group icon-2x green"></i> &nbsp; <a href="#">
												查看所有会员 &nbsp; <i class="icon-arrow-right"></i> </a>
										</div>
									...
									<div id="comment-tab" class="tab-pane">
										<div class="comments">
											<div class="itemdiv commentdiv">
												<div class="user">
													<img alt="Bob Doe's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar.png" />
												</div>
											...
											<div class="itemdiv commentdiv">
												...
												<div class="tools">
													<div class="action-buttons bigger-125">
														<a href="#"> <i class="icon-pencil blue"></i> </a> <a
															href="#"> <i class="icon-trash red"></i> </a>
													</div>
												</div>
											</div>
											...
											<div class="itemdiv commentdiv">
												<div class="user">
													<img alt="Joe's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar2.png" />
												</div>
											...
											<div class="itemdiv commentdiv">
												<div class="user">
													<img alt="Rita's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar3.png" />
												</div>
							...
							<div class="widget-main no-padding">
								<div class="dialogs">
									<div class="itemdiv dialogdiv">
										<div class="user">
											<img alt="Alexa's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar1.png" />
										</div>
									...
									<div class="itemdiv dialogdiv">
										<div class="user">
											<img alt="John's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar.png" />
										</div>
									...
									<div class="itemdiv dialogdiv">
										<div class="user">
											<img alt="Bob's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/user.jpg" />
										</div>
									...
									<div class="itemdiv dialogdiv">
										<div class="user">
											<img alt="Jim's Avatar" src="${URL_ROOT}/resources/ace/assets/avatars/avatar4.png" />
										</div>
...
<!-- page specific plugin scripts -->
		...
		<script src="${URL_ROOT}/resources/ace/assets/js/flot/jquery.flot.js"></script>
