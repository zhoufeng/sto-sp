...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!--[if IE 7]>
            <link rel="stylesheet" href="${URL_ROOT}/resources/css/bootstrap232/ie/font-awesome-ie7.min.css">
        <![endif]-->
        <link rel="stylesheet" href="${URL_ROOT}/resources/js/jqueryplugin/jquery-ui/custom-theme/jquery-ui-1.10.3.custom.css">
        <!--[if lt IE 9]>
            <link rel="stylesheet" href="${URL_ROOT}/resources/js/jqueryplugin/jquery-ui/custom-theme/jquery.ui.1.10.3.ie.css">
        <![endif]-->
    ...
    <body>
        ...
        <div class="navbar navbar-inverse navbar-static-top">
            <div class="navbar-inner">
                <div class="container" >
                    <div>
                        <a class="brand" style="padding:6px 20px 4px 20px" href="${URL_ROOT}/index.php" ><img src="${URL_ROOT}/resources/img/sjxqlogo.png" alt="手机详情工厂"></a>

                    </div>
                    <ul class="nav navbar-nav">  
                        <li><a href="${URL_ROOT}/secondStep">浏览模板</a></li>
                    </ul>
                    ...
                    <div class="nav-collapse collapse pull-right">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="#" target="_blank">订购</a></li>
                            <li class="dropdown">
        ...
        <!--[if lt IE 9]>
             <script src="${URL_ROOT}/resources/js/respond.min.js"/>
        <![endif]-->
